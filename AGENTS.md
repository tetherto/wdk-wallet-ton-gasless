...
- **Domain:** TON Gasless Wallet.
- **Key Libraries:** `@ton/ton`, `@ton-api/client`.
- **Features:** Paymaster integration (Battery Service).
- **Architecture:** Wraps standard TON transactions in gasless envelopes handled by a relay.
